...
<div class="card-wrapper">
      <div class="card">
        ...
        <div class="product-content">
          <h2 class="product-title">Harry Potter Collection</h2>
    ...
    <div class="accordian">
          ...
          Category: <span> <a href="../categories/books.php">Books</a></span>
            </ul>
          </div>

          <div class="purchase-info">
            <form action="HarryPotter.php" method="post" enctype="multipart/form-data">
