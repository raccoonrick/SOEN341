      ...
      <div class="card">
        ...
        <div class="product-imgs">
          <div class="img-display">
            <div class="img-showcase">
              <img class="product-img" src="../img/TV1.jpg" alt="TV image" />
              <img class="product-img" src="../img/TV2.jpg" alt="TV  image" />
              <img class="product-img" src="../img/TV3.jpg" alt="TV  image" />
            </div>
          </div>
        ...
        <div class="product-content">
          ...
          <div class="product-price">
            ...
            <p class="new-price">New Price: <span class="price">$1499.99</span></p>
          </div>
        <div class="accordian">
